...
<Page Expanded="yes" ID="Masomo_DropoutModelling" Enabled="no">
...
<Parameter ID="Masomo_UseNewModellingOption" state="changed">Yes</Parameter>
...
<Page Expanded="yes" ID="Masomo_Analysis" Enabled="no">
...
<Page Expanded="yes" ID="Masomo_DropoutStatisticsPrint" Enabled="no">
