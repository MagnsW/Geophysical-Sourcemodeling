...
foreach $subst (@subst){
	...
	foreach $subarrayseparation (@subarrayseparation){
		...
		$arrayname = "4135H__".$depth3digits."_2000_0".($subarrayseparation*10)."_".$subst;
		$arraynameref = "4135H__".$depth3digits."_2000_0".($subarrayseparation*10)."_alt2";
	    }else{
		$arrayname = "4135H__".$depth3digits."_2000_".($subarrayseparation*10)."_".$subst;
		$arraynameref = "4135H__".$depth3digits."_2000_".($subarrayseparation*10)."_alt2";
	    }
...
');
	    foreach $temp (@temp){
		if ($subarrayseparation<10){
		$statfilename = "4135H__".$depth3digits."_0".($subarrayseparation*10)."_".$subst."_".$temp;
	    }else{
		$statfilename = "4135H__".$depth3digits."_".($subarrayseparation*10)."_".$subst."_".$temp;
	    }
