...
foreach $arraydepth (@arraydepth){
	...
	if ($subarrayseparation<10){
	    $arrayname = "4130T__".$depth3digits."_2000_0".($subarrayseparation*10);
	}else{
	    $arrayname = "4130T__".$depth3digits."_2000_".($subarrayseparation*10);
        }
...
<Page Expanded="yes" ID="DataMgrFullArray" Enabled="no">
...
<Entity name="FullArray">
<Key name="name" state="changed">',$arrayname,'_alt2</Key>
</Entity>
</Entity>
</Parameter>
</ParameterGroup>
...
<Key name="name" state="changed">2018_06_MasterMatrix</Key>
<Entity name="FullArray">
<Key name="name" state="default">',$arrayname,'_alt2</Key>
</Entity>
</Entity>
</Parameter>
...
<Parameter ID="Masomo_UseNewModellingOption" state="changed">2.0</Parameter>
...
<Parameter ID="Masomo_DropoutArrayInfo" state="default">',$arrayname,'_alt2</Parameter>
<Parameter ID="Masomo_SeparatorOutput" state="changed"></Parameter>
...
<Parameter ID="Masomo_SeparatorEmpty" state="changed"></Parameter>
<Parameter ID="Masomo_SampleIntervalFF" state="default">0.5</Parameter>
<Parameter ID="Masomo_SignatureLength" state="changed">400</Parameter>
<Parameter ID="Masomo_ReflectionCoeffNotionalsDropout" state="default">-1</Parameter>
