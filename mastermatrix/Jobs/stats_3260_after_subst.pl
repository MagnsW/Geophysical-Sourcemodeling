...
@temp = (5, 10, 15, 20, 25);
@subst = ('00', '01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12');
#@subst = ('11', '12');
$postfix = "";
$arrayconfig = "3260T";
...
foreach $subst (@subst){
	...
	foreach $subarrayseparation (@subarrayseparation){
		...
		$arrayname = $arrayconfig."__".$depth3digits."_2000_0".($subarrayseparation*10)."_".$subst;
		$arraynameref = $arrayconfig."__".$depth3digits."_2000_0".($subarrayseparation*10);
	    }else{
		$arrayname = $arrayconfig."__".$depth3digits."_2000_".($subarrayseparation*10)."_".$subst;
		$arraynameref = $arrayconfig."__".$depth3digits."_2000_".($subarrayseparation*10);
	    }
...
');
	    foreach $temp (@temp){
		if ($subarrayseparation<10){
		$statfilename = $arrayconfig."__".$depth3digits."_0".($subarrayseparation*10)."_".$subst."_".$temp;
	    }else{
		$statfilename = $arrayconfig."__".$depth3digits."_".($subarrayseparation*10)."_".$subst."_".$temp;
	    }
