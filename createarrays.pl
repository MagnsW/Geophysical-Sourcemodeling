...
#15/09/2019: Added new triple source array: 3280
...
@pressure = (2000, 2500);
@guntype = (G_, T_, S_, LT); #Note that G-gun II is covered separately since volumes are special (controlled by the $arr3111H, $arr3265H, $arr4135H and $arr6222H parameter below)
@arraydepth = (4, 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 8, 8.5, 9);
@subarrayseparation = (8, 10, 12.5);
$subdepth = 4;
...
foreach $gun (@guntype){
	...
	foreach $press (@pressure){
	    $filename = "1600".$gun."_".($subdepth3digits)."_".$press."_SUB.G1X";
...
<SubArray Description="" Major="1" Minor="1" Patch="0">
  ...
  <ParameterGroup ID="Guns">
    ...
    <ParameterGroup ID="Gun Parameters">
      <Parameter ID="GunLabel" type="integer">4</Parameter>
      <Parameter ID="GunType" type="integer">18</Parameter>
      <Parameter ID="GunXPosition" type="float">3</Parameter>
      <Parameter ID="GunYPosition" type="float">-0.4</Parameter>
      <Parameter ID="GunZPosition" type="float">',$subdepth,'</Parameter>
      <Parameter ID="GunVolume" type="float">150</Parameter>
    ...
    <ParameterGroup ID="Gun Parameters">
      ...
      <Parameter ID="GunZPosition" type="float">',$subdepth,'</Parameter>
      <Parameter ID="GunVolume" type="float">90</Parameter>
      <Parameter ID="GunPressure" type="float">2000</Parameter>
      <Parameter ID="GunWaveshapeKit" type="float">1</Parameter>
      <Parameter ID="GunFiringDelay" type="float">0</Parameter>
      <Parameter ID="GunActivation" type="integer">1</Parameter>
      <Parameter ID="GroupLabel" type="integer">1</Parameter>
...
foreach $gun (@guntype){
	...
	foreach $press (@pressure){
	    $filename = "1680".$gun."_".($subdepth3digits)."_".$press."_SUB.G1X";
...
foreach $gun (@guntype){
	...
	foreach $depth (@arraydepth){
	    ...
	    foreach $sep (@subarrayseparation){
	       if ($sep<10){
		   $filename = "3150".$gun."_".($depth3digits)."_".$press."_0".($sep*10).".G2X";
	       }else{
		   $filename = "3150".$gun."_".($depth3digits)."_".$press."_".($sep*10).".G2X"; 
	       }
open(OUTPUT, ">$filename");
print("Creating file: ",$filename,"\n");
print OUTPUT ('<?xml version="1.0" encoding="UTF-8" standalone="no" ?>
...
foreach $gun (@guntype){
    foreach $press (@pressure){
	$subarray1 = "1680".$gun."_".($subdepth3digits)."_".$press."_SUB";
	$subarray2 = "1600".$gun."_".($subdepth3digits)."_".$press."_SUB";
	foreach $depth (@arraydepth){
	    $reldepth = $depth-$subdepth;
	    $depth3digits = sprintf("%03d", $depth*10);
	    foreach $sep (@subarrayseparation){
	       if ($sep<10){
		   $filename = "3280".$gun."_".($depth3digits)."_".$press."_0".($sep*10).".G2X";
	       }else{
		   $filename = "3280".$gun."_".($depth3digits)."_".$press."_".($sep*10).".G2X"; 
	       }
open(OUTPUT, ">$filename");
print("Creating file: ",$filename,"\n");
print OUTPUT ('<?xml version="1.0" encoding="UTF-8" standalone="no" ?>
...
if ($arr4135H eq true){
	...
	foreach $depth (@arraydepth){
	    ...
	    foreach $sep (@subarrayseparation){
	       if ($sep<10){
		   $filename = "4135H__".($depth3digits)."_".$press."_0".($sep*10).".G2X";
	       }else{
		   $filename = "4135H__".($depth3digits)."_".$press."_".($sep*10).".G2X"; 
	       }
open(OUTPUT, ">$filename");
print("Creating file: ",$filename,"\n");
print OUTPUT ('<?xml version="1.0" encoding="UTF-8" standalone="no" ?>
